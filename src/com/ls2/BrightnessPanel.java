...
public class BrightnessPanel extends JPanel implements MouseListener, MouseMotionListener {
	...
	private final Font fontBold20 = new Font(Font.SANS_SERIF, Font.BOLD, 20);
	private final Color TextColor150 = new Color(150,150,150);
	...
	private final Stroke stroke3 = new BasicStroke(3.0f);
