...
public class CropDialog extends JDialog implements ActionListener, DocumentListener, PropertyChangeListener {
	...
	public CropDialog(JFrame frame, String title, boolean modal, CropPanel cap) {
	    ...
	    //ratioField1.addPropertyChangeListener(this);
	    ...
	    //ratioField2.addPropertyChangeListener(this);
	    ...
	    orientationList = new JComboBox(orientationStrings);
	...
	private void setRatio() {
		try {
			//float num1 = Float.valueOf(ratioField1.getText());
			//float num2 = Float.valueOf(ratioField2.getText());
