...
public class ListImgViewer extends View {
	...
	public void setLayoutType(int type) {
		...
		case 2: 
			leftMargin = 10;
			horzAlign.add(new Integer(0));
			horzAlign.add(new Integer(490));			
			break;
		case 3:
			leftMargin = 10;
			horzAlign.add(new Integer(0));
			horzAlign.add(new Integer(330));
			horzAlign.add(new Integer(660));	
			break;
		}
      		...
      		if ( !settings.FilterState || (settings.FilterState && !IV.imageAnalysis.Hidden ) ) {
      			...
      			if ( (RegionY2 >= visRect.y) && (RegionY1 <= (visRect.y + visRect.height)) ) {
			    	...
			    	if ( curMouseRegion != null) {
			      	...
			      	//g.draw3DRect(ImgBoxX1-1, ImgBoxY1-1, imgBoxWidth+2, imgBoxHeight+2, true);
		            ...
		            int H_S_Flag_Loc = Rotation_Loc2 + 21;
		            ...
		            int Grid_3rds_Loc = H_S_Flag_Loc2 + 21;
		            ...
		            int Selected_Loc = Grid_3rds_Loc2 + 21;
		            int Selected_Loc2 = Selected_Loc + 50;
		  			...
		  			if (horzAlign.size() == 1 ) {
				    	...
				    	int[] aryB;  
				    	if ( IV.ActHist_Flag ) {
			    			totImgPix = IV.imageAnalysis.imageHeight*IV.imageAnalysis.imageWidth;
			    			...
			    			totImgPix = CacheImage.getHeight()*CacheImage.getWidth();
			            ...
			            dblHistFact = (((double)(imgBoxHeight)*0.4*256.0*dblFactor)/((float)(totImgPix)));
			            int lineLen = 0;
			            int r = 0;
				    	...
				    	if ( IV.ActHist_Flag ) {
					    	...
					    	activeRegions.add(new ActiveRegion("Hist_Actual", ActiveRegion.TEXT_CMD, x, HistTitleX1-2, HistTitleY1-12, HistTitleX1+117, HistTitleY1+4 ));
				    	}else {
					    	g.drawString("Histograms [Approx]", HistTitleX1, HistTitleY1);
					    	activeRegions.add(new ActiveRegion("Hist_Approx", ActiveRegion.TEXT_CMD, x, HistTitleX1-2, HistTitleY1-12, HistTitleX1+119, HistTitleY1+4 ));
				    	}
		  			}
      			}
