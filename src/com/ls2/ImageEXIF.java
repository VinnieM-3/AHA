...
public class ImageEXIF {
	...
	//public String imageExpProgram = "?";
	//public String imageMeteringMode = "?";	
	public String imageFlashMode = "?";
	//public String imageExpMode = "?";
	//public String imageWhiteBalance = "?";	
...
//		int[] makeCode = {0x01,0x0F};
//		FieldEntry fe = new FieldEntry(makeCode);
//		cameraMake = fe.getFieldValue();
//	}
...
//	private void getExposureProgram() {
//		String exposureProgram = null; //lookup
//		int[] exposureProgramCode = {0x88,0x22};
//		FieldEntry fe = new FieldEntry(exposureProgramCode);
//		exposureProgram = fe.getFieldValue();
//		if (!exposureProgram.equals("?")) {
//			int ep = Integer.valueOf(exposureProgram);
//			switch(ep) {
//			case 0:
...
//			}
//		}
//		imageExpProgram = exposureProgram;
//	}
...
//	private void getMeteringMode() {
//		String meteringMode = null; //lookup
//		int[] meteringModeCode = {0x92,0x07};
//		FieldEntry fe = new FieldEntry(meteringModeCode);
//		meteringMode = fe.getFieldValue();
//		if (!meteringMode.equals("?")) {
//			int mm = Integer.valueOf(meteringMode);
//			switch(mm) {
//			case 0:
...
//	private void getExposureMode() {
//		String exposureMode = null; //lookup
//		int[] exposureModeCode = {0xA4,0x02};	
//		FieldEntry fe = new FieldEntry(exposureModeCode);
//		exposureMode = fe.getFieldValue();
//		if (!exposureMode.equals("?") ) {
//			int em = Integer.valueOf(exposureMode);
//			switch(em) {
//			case 0:
...
//			}
//		}
//		imageExpMode = exposureMode;
//	}
	
//	private void getWhiteBalance() {
//		String whiteBalance = null; //lookup
//		int[] whiteBalanceCode = {0xA4,0x03};
//		FieldEntry fe = new FieldEntry(whiteBalanceCode);
//		whiteBalance = fe.getFieldValue();
//		if (!whiteBalance.equals("?") ) {
//			int wb = Integer.valueOf(whiteBalance);
//			switch(wb) {
//			case 0:
//				whiteBalance = "Auto";
//				break;
...
//	}
    ...
    public static void main(String[] args) {
		...
		//System.out.println("MeteringMode=" + e.imageMeteringMode);
		System.out.println("FocalLength=" + e.imageFocalLength);
		//System.out.println("ExposureMode=" + e.imageExpMode);
		//System.out.println("WhiteBalance=" + e.imageWhiteBalance);
