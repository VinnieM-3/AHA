...
public class MainFrame implements ActionListener, ItemListener, ComponentListener {
...
//       		settings.loadConfig();
 	       	...
 	       	JOptionPane.showMessageDialog(frame, "Error loading configuration file.  System will use default settings.", "Error Loading Configuration File", JOptionPane.ERROR_MESSAGE);
       	}
     }
    ...
    public JMenuBar createMenuBar() {
        ...
        rbHome.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_0, ActionEvent.ALT_MASK));
...
//        menuBar.add(menu);
	...
	private void writeFile(String completePath, BufferedImage img) {
		...
		try {
			...
			JPEGImageWriter writer = (JPEGImageWriter)ImageIO.getImageWritersBySuffix("jpeg").next();
...
//            // Metadata (dpi)
//            IIOMetadata data = writer.getDefaultImageMetadata(new ImageTypeSpecifier(img), iwp);
...
//            jfif.setAttribute("resUnits", "1");    
    ...
    private static void createAndShowGUI() {
        ...
        frame = new JFrame("Aha - Advanced Histogram Analyzer");
